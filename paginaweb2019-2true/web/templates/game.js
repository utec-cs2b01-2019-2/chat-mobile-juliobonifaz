...
function whoami(){
    ...
    function sendwords(){
        ...
        $.ajax({
            ...
            success: function(response){
                //alert(JSON.stringify(response));
                t = '<div class="alert alert-secondary" ><P align=center>Tu respuesta esta '+response+'</P></div><input type="button" onclick="window.location.reload();" value="otra pregunta"><input type="button" onclick="report()" value="pregunta con error?">';
